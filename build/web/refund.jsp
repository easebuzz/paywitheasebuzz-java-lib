    ...
    <body>
        <div class="grid-container">
            ...
            <div class="form-container">
                <h2>REFUND API</h2>
                <hr>
                <form action="refund_return.jsp" method="post" name="RefundForm">
                    <div class="main-form">
                        ...
                        <div class="mandatory-data">
                            ...
                            <div class="form-field">
                                ...
                                <input id="txnid" class="txnid" name="txnid" value="" required placeholder="SBD12345">
                            </div>
            
                            <div class="form-field">
                                <label for="refund_amount">Refund Amount<sup>(should be float)*</sup></label>
                                <input id="refund_amount" class="refund_amount" name="refund_amount" value="" required placeholder="125.25">
                            </div>
                            ...
                            <div class="form-field">
                                ...
                                <input id="email" class="email" name="email" value="" required placeholder="refund@easebuzz.in">
                            </div>
