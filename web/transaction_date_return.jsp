...
<%@ include file="config.jsp" %>
    ...
    <%
        ...
        if (env.equals("prod")) {
            ...
            base_url = "https://testdashboard.easebuzz.in/transaction/v2/retrieve/date";
        }
        ...
        try {
            if (empty(merchant_email)) {
                throw new Exception("Merchant email is required");
            }
            if (empty(start_date)) {
            ...
            // Build JSON payload instead of form data
            JSONObject payload = new JSONObject();
            payload.put("key", merchant_key);
            payload.put("merchant_email", merchant_email);
            
            // Create date_range JSON object
    ...
    %>
        ...
        <div class="response-container">
            ...
            <% if (!empty(submerchant_id)) { %>
                <p><strong>Sub Merchant ID:</strong> <%= submerchant_id %></p>
            <% } %>
